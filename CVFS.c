...
void man(char *name)
{
    ...
    else if(strcmp(name, "write") == 0)
    {
        ...
        printf("Usage : write File_name\n Then, Enter data that you wish to write\n");
    }
...
void DisplayHelp()
{
    ...
    printf("clear/cls : To clear console\n");
    ...
    printf("Permissions(1/2/3) : 1-Read Only; 2-Write Only; 3-Read & Write\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminating Aditi's Virtual File System\n");
                break;
            }
            else
            {
        ...
        else if(count == 3)
        {
            ...
            else if(strcmp(command[0], "open") == 0)
            {
                ...
                if(ret == -3)
                    printf("ERROR : Permissionh denied\n");
                continue;
            }
            else if(strcmp(command[0], "read") == 0)
            {
                ...
                if(ret == -2)
                    printf("ERROR : Permission denied\n");
                if(ret == -3)
                    printf("ERROR : Reacjed end of file\n");
                if(ret == -4)
                    printf("ERROR : It is not a regular file\n");
                if(ret == 0)
